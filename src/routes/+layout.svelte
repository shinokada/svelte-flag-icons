...
<MetaTags
  title="Svelte Flag Icons"
  description="Flag Icon set for Svelte"
  openGraph={{
    type: 'website',
    url: 'https://svelte-flag-icons.codewithshin.com/',
    title: 'Svelte Flag Icons',
    description: 'Flag Icon set for Svelte',
    images: [
      {
        url: 'https://open-graph-vercel.vercel.app/api/svelte-flag-icons',
        width: 1200,
        height: 630,
        alt: 'Svelte Flag Icons'
      }
    ],
    siteName: 'Svelte Flag Icons'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: 'Svelte Flag Icons',
    description: 'Flag Icon set for Svelte',
    image: 'https://open-graph-vercel.vercel.app/api/svelte-flag-icons',
...
<div class="max-h-screen overflow-auto relative w-full" id="svelte">
  <header
    class="sticky top-0 z-40 flex-none w-full mx-auto bg-white border-b border-gray-200 dark:border-gray-600 dark:bg-neutral-950"
  >
    <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-neutral-950 ">
      ...
      >
        ...
        <NavLi href="https://github.com/shinokada/svelte-flag-icons">GitHub</NavLi>
  ...
  <Footer footerType="logo" class="dark:bg-neutral-950">
    <div class="sm:flex sm:items-center sm:justify-between">
      ...
      >
        ...
        <FooterLink href="https://github.com/shinokada/svelte-flag-icons/blob/main/LICENSE"
          >Licensing</FooterLink
        >
        <FooterLink href="https://github.com/shinokada/svelte-flag-icons/">GitHub</FooterLink>
      </FooterLinkGroup>
    </div>
  </Footer>
</div>
