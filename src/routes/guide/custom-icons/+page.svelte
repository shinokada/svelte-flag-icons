...
<h1>Custom icons - Svelte Flag Icons</h1>
...
<p>
  Here, we import the <Code>MyIcon</Code> component and the <Code>Jp</Code> icon. By passing the <Code
    >Jp</Code
  > icon to the <Code>icon</Code> prop of MyIcon, you apply the default configuration to the icon.
</p>
