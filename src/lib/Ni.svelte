...
>
	...
	<defs>
		...
		>
			<stop offset="0" stop-color="#510000" /> <stop offset=".3" stop-color="#8a0000" />
		...
		<linearGradient
			...
			gradientUnits="userSpaceOnUse"
		>
			<stop offset="0" stop-color="#ff2a2a" /> <stop offset="1" stop-color="red" />
		</linearGradient>
		<linearGradient
			id="ni-b"
			x1="484.8"
			...
			gradientUnits="userSpaceOnUse"
		>
			<stop offset="0" stop-color="#F5F549" /> <stop offset="1" stop-color="#97C924" />
		</linearGradient>
		<linearGradient id="ni-a">
			<stop offset="0" stop-color="#025" /> <stop offset=".5" stop-color="#04a" />
		...
		<linearGradient
			...
			gradientUnits="userSpaceOnUse"
		/> <clipPath id="ni-c"> <path d="m500 226.4-63.7 110.3h127.4z" /> </clipPath>
	...
	<g clip-path="url(#ni-c)" transform="translate(-80)scale(.8)">
		...
		<g id="ni-e">
			...
			</g> <use xlink:href="#ni-d" width="100%" height="100%" transform="rotate(72 500 285.5)" />
		...
		</g> <use xlink:href="#ni-e" width="100%" height="100%" transform="rotate(8 500 285.5)" />
		...
		<g fill="url(#ni-h)">
			...
			</g> <use xlink:href="#ni-n" width="100%" height="100%" y="-3.3" fill="url(#ni-o)" />
		...
		<g fill="#ccd11e">
			...
			</g> <use xlink:href="#ni-t" width="100%" height="100%" x="-15.3" />
			<g fill="#c6cb24">
				<path
					fill="url(#ni-u)"
			...
			</g> <use xlink:href="#ni-w" width="100%" height="100%" x="-15.4" fill="#c6cb24" />
		</g>
		<path
			fill="#fff"
		...
		</g> <use xlink:href="#ni-A" width="100%" height="100%" y="-3.9" />
