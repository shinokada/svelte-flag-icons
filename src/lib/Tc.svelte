		...
		<g stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2">
			...
			<g fill="#9e540a" transform="translate(535 249.6)scale(.125)">
				<g id="tc-b">
					...
					<g stroke="none">
						...
						/>
					</g> <path d="M-19 187s-28 50-49 86-38 44-54 33c-15-11-2-40 10-54s79-79 79-79z" />
				...
				</g> <use xlink:href="#tc-b" width="100%" height="100%" transform="scale(-1 1)" />
				<g id="tc-c">
					<path
					...
					/>
				</g> <use xlink:href="#tc-c" width="100%" height="100%" transform="scale(-1 1)" />
			</g>
			<g transform="translate(485 299.6)scale(.125)">
				<g id="tc-d">
					...
					/>
				</g> <use xlink:href="#tc-d" width="100%" height="100%" transform="scale(-1 1)" />
