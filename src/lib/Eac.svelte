<script>
  ...
  export let ariaLabel = 'flag of eac';
</script>
...
>
  ...
  <g transform="translate(41.1 674.6) scale(.87273)">
    ...
    <path
      ...
      stroke="#000"
      stroke-width="1.2"
      d="M317.7-580A70.8 70.8 0 0 0 294-443.4v-7.8a63.5 63.5 0 0 1 25.2-121.6h.5a63.5 63.5 0 0 1 25.6 121.6v7.8A70.7 70.7 0 0 0 319.6-580h-1.9z"
    />
    <path
      fill="#fff"
      fill-rule="evenodd"
      stroke="#000"
      stroke-width=".870727"
      d="m339-458.3.1 10.6c-6.4 1-13.5 7.6-15.4 8.8-1.9 1.3-5 3.8-6.7 3.6-2.9-.4-.8-2.7-.8-2.7s-2 2.4-3.4 1.3c-1.4-.9.8-2.7.8-2.7s-.7 1-2.2.5c-1.4-.4-.4-2-.4-2s-3.8 2-4.5 1.3c-1-1.3.4-2.5.4-2.5l8.9-7.5s-5.8 2.1 0 0c4.9-2 6.3.8 8.5.6 2.4-.2 8.5-3.5 10.2-5.1 1.7-1.7 1.2-3.5 2.5-4s2-.2 2-.2z"
    />
    <path
      fill="#fff"
      fill-rule="evenodd"
    ...
    <g fill-rule="evenodd" stroke="#000" stroke-width="3">
      <path
        fill="#0087ff"
        stroke-width=".35675999999999997"
...
@prop export let ariaLabel = 'flag of eac';
-->
