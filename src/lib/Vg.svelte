<script>
  export let size = '24';
  export let ariaLabel = 'flag of vg';
</script>
...
>
  ...
  <g transform="translate(-217.5 -9.4) scale(.77497)">
    ...
    <g id="c" fill="#ffc72c" stroke="#000" stroke-width=".9">
      ...
      <path
        d="M817.4 197.1h21.9s.3-2.8-2.3-4.5c11.5-1.6 8.5-11.6 18-12.2 2 .3-5 4.3-5 4.3s-5.7 4-3 6.1c2 1.7 3-1 3.2-3 .3-2 9.3-3.3 8-9-2.1-4.7-14.7 3.2-14.7 3.2l-9-.1c-.6-1-3-5-5.6-5-3 0-5.2 5-5.2 5h-20.3s-.7 5.3 9.6 6.3c2.3 3 4.1 3.8 6.2 4.6-1.4 1.1-1.8 2.5-1.8 4.3zM819 192.7h18.2"
      />
    ...
    <g fill="none" stroke="#000" stroke-width="1.9">
      ...
      <path
        d="m761.5 429.1-5.6 4.1s14 2.8 10.8 12M1052.3 422.2s-2.7-1.5-7 1.7c-4.4 3.3-15.3 15.5-15.3 15.5"
      />
