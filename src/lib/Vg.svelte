...
>
  ...
  <defs>
    ...
    >
      <stop offset="0" stop-color="red" /> <stop offset="1" stop-color="#ff0" />
    </linearGradient>
  </defs> <path fill="#006" d="M0 0h640v480H0Z" /> <path fill="#012169" d="M0 0h320v240H0Z" />
  <path
    fill="#fff"
  ...
  <g transform="translate(-217.5 -9.4)scale(.77497)">
    ...
    <g id="vg-b" fill="#ffc72c" stroke="#000" stroke-width=".9">
      ...
      <path
        fill="url(#vg-a)"
        d="M809.6 181.8c.6-3.2 1.9-3.8 3.2-8 .2-4-3.2-3.5-2.2-6 1.8-2.9.9-5.6-2.5-7.7.7 3.7-4.4 7.2-4.4 10.2 0 3 2.6 2.4 2.3 7 .2 2.6-.7 2-1 4.5z"
      /> <path d="M831.5 161.7a2.6 2.6 0 1 1-5.2 0 2.6 2.6 0 0 1 5.2 0z" />
    </g> <use xlink:href="#vg-b" width="100%" height="100%" x="-.8" y="41.3" />
