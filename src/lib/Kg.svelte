...
>
  ...
  {/if}
  <defs>
    <clipPath id="kg-a"> <path fill-opacity=".7" d="M-85 0h682.7v512H-85z" /> </clipPath>
  </defs>
  <g fill-rule="evenodd" clip-path="url(#kg-a)" transform="translate(79.6)scale(.9375)">
    ...
    <path fill="red" d="M343.2 256.3a86.3 86.3 0 1 1-172.6 0 86.3 86.3 0 0 1 172.6 0" />
    <path fill="#ff0" d="M331.2 256.5a74 74 0 1 1-148.2 0 74 74 0 0 1 148.2 0" />
    <path
      fill="red"
