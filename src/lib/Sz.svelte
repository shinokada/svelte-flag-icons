...
>
  ...
  {/if}
  <path fill="#3e5eb9" d="M0 0h640v480H0Z" /> <path fill="#ffd900" d="M0 90h640v300H0Z" />
  ...
  <g fill="#ffd900" stroke="#000" transform="translate(-43.2)scale(1.2)">
    <g id="sz-a">
      ...
      />
    </g> <use xlink:href="#sz-a" width="100%" height="100%" x="-23.3" y="17.1" />
  ...
  <g stroke="#fff" transform="translate(-43.2)scale(1.2)">
    <g id="sz-d" stroke-width="6.9">
      ...
      </g> <use xlink:href="#sz-c" width="100%" height="100%" x="41.6" />
    </g>
  </g>
  <use
    xlink:href="#sz-d"
