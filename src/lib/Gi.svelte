<script>
  ...
  export let ariaLabel = 'flag of gi';
</script>
...
>
  ...
  <g stroke="#000" transform="translate(-160) scale(1.875)">
    ...
    <g fill="#f8d80e">
      ...
      />
      <path
        d="M255.3 164.3a5 5 0 0 0-4 5.1v11.2a5 5 0 0 0 4.6 4.6 4.9 4.9 0 0 0 4.8-2.8l-1.7-1a2.9 2.9 0 0 1-3 1.8c-1.6 0-2.9-1.6-2.7-3.1v-11.2a2.9 2.9 0 0 1 3-2.6c.6-.2 1.5.7 1.9 0 .6-.9-.4-1.5-1-2h-1.9zm5.8 3.9a5 5 0 0 1-1.9 1.6v7.5l2 1.1v-10.2z"
      />
    </g>
    <g fill="#da000c">
...
@prop export let ariaLabel = 'flag of gi';
-->
