...
>
  ...
  <g fill="#ffec2d">
    <g transform="matrix(.48 0 0 .48 345.8 201.6)">
      ...
      <g id="kz-c">
        <g id="kz-b">
          ...
          <use xlink:href="#kz-a" width="100%" height="100%" transform="rotate(-90)" />
        </g> <use xlink:href="#kz-b" width="100%" height="100%" transform="rotate(22.5)" />
      ...
      </g> <use xlink:href="#kz-c" width="100%" height="100%" transform="rotate(11.3)" />
    </g>
    ...
    <g transform="scale(.48)">
      ...
      </g> <use xlink:href="#kz-f" width="100%" height="100%" transform="matrix(1 0 0 -1 0 1000)" />
    </g>
  </g>
</svg>
