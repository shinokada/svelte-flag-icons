...
>
	...
	<defs>
		...
		/>
	</defs> <path fill="#fff" d="M0 0h640v480H0z" /> <path fill="#000001" d="M0 0h640v144H0z" />
	...
	</g> <use xlink:href="#ke-b" width="100%" height="100%" transform="matrix(-1 0 0 1 640 0)" />
	<path
		fill="#b00"
	...
	<g fill="#fff" transform="matrix(3 0 0 3 320 240)">
		<ellipse rx="4" ry="6" /> <path id="ke-d" d="M1 5.8s4 8 4 21-4 21-4 21z" />
