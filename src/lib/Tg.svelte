<script>export let size="24";export let ariaLabel="flag of tg" </script><svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-tg" width={size} height={size} class={$$props.class} {...$$restProps} aria-label={ariaLabel} viewBox="0 0 640 480">
  <defs>
    <clipPath id="tg-a">
