...
>
	...
	<g font-size="12">
		...
		<path
			...
			stroke="#000"
			stroke-width="1.5"
			d="M296.1 203.2s-12.4-6-24.1 2.8c0 0-21.1-3-22.7 17.2 0 .8-.2 2.3.2 2.8q.7.8.8 1.8t.5 1.1q.2.3.5 1.7c0 1.1-.2 1.6.9 2.7 1 1 1 4.1 1 5s.6 3.3 1 3.8 1.3 1.8 1.3 2.9.4 4 .2 4.7 1.2 1.7 2.4 2.1 16 5.2 37.6 4.8c21.6-.3 29.4-1.5 38.4-4.7a2 2 0 0 0 1.5-2.3c-.2-.6 0-2.6.3-3.1.4-.5 3-4.6 2.4-5.3-.5-.8-.5-2.4 0-3s2.1-3.7 2.4-5 .4-2.7 1-3.1.7-1.9.8-2.2a4 4 0 0 1 1.2-1.6s1-5.1.4-7.6-4.5-13.3-19.8-11c0 0-11.4-8.7-28.2-4.5z"
			transform="matrix(1.06667 0 0 1.06758 0 -76)"
		/>
		<path
			fill="#bcac0b"
			d="M360.1 181c-50.1-15.8-89-.7-89-.7s.5 1.7.9 2.3 1 1.8 1 2.7v3c0 .8-.4 4 2.4 3.9 0 0 35-13.7 80.4.7 0 0 1.3-1 1.3-2.6a9 9 0 0 1 1-4.3c.6-.9 2-3.6 2-5"
		/>
		<path
			fill="#c8b100"
			fill-opacity=".9"
		...
		<path
			fill="#fff"
			d="M303.9 130.8c2-.2 3.5-.5 3.4-.8 0-.3-1.6-.3-3.5-.2q-3.2.3-3.4.8c0 .3 1.6.3 3.5.2"
		/>
		<path
			fill="none"
			stroke="#000"
		...
		<path
			...
			stroke="#000"
			stroke-width=".7"
			d="M340.2 234.1s-.8-2-2.5-1.3-1.5 1-3 1c0 0-.6-1.9.2-2.7 0 0-2.4-.9-3-3 0 0 1.3-1.5 4.4-.9 0 0-.1-1.5.3-2.2 0 0 3.3 1 3.3 2.9 0 0-1-3.6.8-6.2 0 0 1.5.6 1.4 2.3 0 0 .7-3.4 5.2-2.5 0 0-2.4 2.2-2.5 3.2s-2.2 2.7-2.3 3.3-.2 1.5-.8 2.1-.7 1.6-.7 2c0 .2 0 1.6-.8 2z"
			transform="matrix(1.06667 0 0 1.06758 0 -76)"
		/>
		<path
			fill="#fff"
			d="M360.2 169.7a3.2 3.2 0 0 1 5.1-2q0 1-.8 2c-.7.6-.8 1.7-.8 2a3 3 0 0 1-.4 1.8h-.5a3 3 0 0 1-2.6-3.8"
		/>
		<path
			fill="none"
			stroke="#000"
			stroke-width=".4"
			d="M337.7 230.1a3 3 0 0 1 4.8-1.8q0 .9-.8 1.8c-.6.6-.7 1.6-.7 2a3 3 0 0 1-.4 1.6h-.5a3 3 0 0 1-2.4-3.6z"
			transform="matrix(1.06667 0 0 1.06758 0 -76)"
		/>
		<path
			fill="#fff"
			d="M361.6 170a1.8 1.8 0 0 1 3.2-.8l-.3.5c-.7.6-.8 1.7-.8 2v.3h-.6q-1.6-.3-1.4-2.1"
		/>
		<path
			fill="none"
			stroke="#000"
			stroke-width=".3"
			d="M339 230.4a1.7 1.7 0 0 1 3-.7l-.3.4c-.6.6-.7 1.6-.7 2v.2h-.6q-1.6-.3-1.3-2z"
			transform="matrix(1.06667 0 0 1.06758 0 -76)"
		/>
		<path
			fill="#fc0"
			d="M269 173s.9-2 2.7-1.2c1.7 1 1.5 1.2 3.2 1.2 0 0 .6-2 0-2.8 0 0 2.5-.8 3.2-3 0 0-1.3-1.7-4.6-1.3 0 0 .2-1.6-.2-2.3 0 0-3.5.8-3.6 2.7 0 0 1.2-3.7-.5-6.6 0 0-1.7.7-1.7 2.4 0 0-.5-3.7-5.3-3 0 0 2.4 2.5 2.4 3.6s2.2 3 2.2 3.6.2 1.7.8 2.4.7 1.7.6 2.1c0 .2 0 1.7.8 2.2"
		/>
		<path
			fill="#bcac0b"
			stroke="#000"
			stroke-width=".7"
			d="M252.2 233.3s.8-2 2.5-1.2 1.4 1.1 3 1.1c0 0 .6-1.8 0-2.6 0 0 2.4-.7 3-2.8 0 0-1.2-1.6-4.3-1.2 0 0 .2-1.5-.2-2.2 0 0-3.3.8-3.4 2.6 0 0 1.2-3.5-.4-6.2 0 0-1.6.6-1.6 2.2 0 0-.5-3.4-5-2.7 0 0 2.3 2.3 2.3 3.3s2 2.8 2 3.4c0 .5.2 1.6.8 2.2s.6 1.6.5 2c0 .2 0 1.6.8 2z"
			transform="matrix(1.06667 0 0 1.06758 0 -76)"
		/>
		<path
			fill="#fff"
			d="M271.8 168.9a3.2 3.2 0 0 0-5-2.1q0 1 .8 1.9c.7.6.7 1.7.6 2.1q-.1.4.4 1.8h.4a3.2 3.2 0 0 0 2.8-3.7"
		/>
		<path
			fill="none"
			stroke="#000"
			stroke-width=".4"
			d="M254.8 229.4a3 3 0 0 0-4.6-2q0 .9.7 1.8c.6.6.6 1.6.5 2q-.1.5.4 1.7h.4a3 3 0 0 0 2.6-3.5z"
			transform="matrix(1.06667 0 0 1.06758 0 -76)"
		/>
		<path
			fill="#fff"
