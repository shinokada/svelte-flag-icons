<script>export let size="24";export let ariaLabel="flag of es ga" </script><svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-es-ga" version="1.0" width={size} height={size} class={$$props.class} {...$$restProps} aria-label={ariaLabel} viewBox="0 0 640 480">
