...
>
  ...
  <g font-size="12">
    ...
    <path
      fill="#fc0"
      d="M324 112.5h-6.8v-11h2.7v-2.2h-2.7v-2.7h-2.1v2.6h-2.7v2.2h2.6v11.1h-6.4v1.5H324v-1.5"
    />
    <path
      fill="#bcac0b"
      stroke="#000"
    ...
    <path
      fill="#fc0"
      d="M310.5 126V150c-.2 2.3 2.9 5.7 5.1 6.6 0 0 5.4-1.7 5.7-6.6v-25h-1.8v21.7c0 2.1-1.5 6.2-3.6 6.8 0 0-3.8-.6-4-6.8v-21.1l-1.4.6"
    />
    <path
      fill="#bcac0b"
      stroke="#000"
    ...
    <path
      ...
      stroke="#000"
      stroke-width=".5"
      d="m256 247.8 4.2-3.5-4.7-.9s.6.7.5 1.4v3zM337.6 242.7l-7.7 1.4 5.2 6"
      transform="matrix(1.06667 0 0 1.06758 0 -76)"
    />
    ...
    <path
      fill="#fc0"
      d="M362.9 174s-.9-2.2-2.7-1.5-1.6 1.1-3.2 1.1c0 0-.6-2 .2-2.9 0 0-2.5-1-3.2-3.2 0 0 1.4-1.6 4.7-1 0 0 0-1.5.3-2.3 0 0 3.6 1 3.6 3.1 0 0-1.1-3.8.8-6.6 0 0 1.6.6 1.5 2.4 0 0 .8-3.6 5.6-2.6 0 0-2.6 2.3-2.7 3.4-.2 1-2.4 2.9-2.5 3.5 0 .5-.2 1.6-.8 2.3-.7.6-.8 1.7-.8 2 0 .3 0 1.8-.8 2.2"
    />
    <path
      fill="#bcac0b"
      stroke="#000"
