...
>
  ...
  {/if}
  <defs> <clipPath id="mz-a"> <path fill-opacity=".7" d="M0 0h682.7v512H0z" /> </clipPath> </defs>
  <g clip-path="url(#mz-a)" transform="scale(.9375)">
    ...
    <path
      ...
      stroke-width="1.1"
      d="M102.8 290.9h37c3 3.3 9.5 4.7 15.8 0 11.6-6.4 34 0 34 0l4.4-4.7-10.7-35.2-3.9-4.2s-8.3-5-24-3.3c-15.7 1.7-21.2-.5-21.2-.5s-13.7 1.6-17.6 3.6l-4.4 4.4z"
    />
    <path
      fill="none"
      stroke="#000"
