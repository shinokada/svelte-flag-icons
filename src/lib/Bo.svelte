<script>export let size="24";export let ariaLabel="flag of bo" </script><svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-bo" width={size} height={size} class={$$props.class} {...$$restProps} aria-label={ariaLabel} viewBox="0 0 640 480">
