<script>
	export let size = '24';
	export let ariaLabel = 'flag of sm';
</script>
...
>
	...
	<g id="g434" fill="#fff" fill-rule="evenodd">
		...
		<path
			id="path432"
			d="M317 329.3c-3.2-.6-4.4-.4-6.6-.6l-5.1 15.8c8 .7 15.3.7 15.3.7-4.8-1-3.7-15.8-3.6-15.9z"
		/>
	</g>
	<g
		id="g468"
		...
		font-size="9"
		font-weight="bold"
		transform="translate(-465 -233.3) scale(1.6657)"
	>
		...
		<g id="text446" aria-label="B">
			<path
				id="path563"
				d="M459.3 345.1h-2v-6.4l1.9-.1q1 0 1.5.4.6.5.6 1.3 0 .7-.8 1.2 1.2.4 1.2 1.7 0 .9-.7 1.4-.6.5-1.7.5zm-.8-5.5v1.5h.6q1 0 1-.8 0-.7-1-.7h-.6zm0 2.4v2.1h.6q.7 0 1-.2.4-.2.4-.8 0-.6-.3-.8-.3-.3-1.1-.3h-.6z"
			/>
		</g>
		...
		<g id="text454" aria-label="R">
			<path
				id="path569"
				d="m472.6 345.6-1.7-2.7h-.8v2.7H469v-6.4h.7l1-.1q2.5 0 2.5 1.9 0 .6-.3 1-.4.5-.9.7l2 2.9zm-2.5-5.4v1.7h.5l1-.1q.4-.2.4-.8 0-.5-.3-.7-.4-.2-1.2-.2h-.4z"
			/>
		</g>
		...
		<g id="text462" aria-label="A">
			<path
				id="path575"
				d="m483.7 344.5-.5-1.3H481l-.4 1.3h-1.3l2.6-6.5h.5l2.6 6.5zm-1.6-4.6-.7 2.4h1.5z"
			/>
		</g>
		<g id="text466" aria-label="S">
			<path
				id="path578"
				d="m485.9 344 .4-1q.7.4 1.3.4 1 0 1-.7l-.2-.6-1-.7-1-.6-.4-.6-.1-.7q0-.8.5-1.3.6-.4 1.4-.4 1.1 0 1.7.4l-.4 1q-.6-.5-1.3-.5-.4 0-.6.2-.2.2-.2.6 0 .5 1.2 1.1.7.3 1 .6l.4.6.1.8q0 .8-.6 1.3t-1.6.5q-1 0-1.6-.5z"
			/>
		</g>
	</g>
	<path
