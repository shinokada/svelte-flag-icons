<script>
	export let size = '24';
	export let ariaLabel = 'flag of gu';
</script>
...
>
	...
	<text
		...
		font-size="25.6"
		transform="matrix(1.33 0 0 1.33 -363 -108)"><tspan id="tspan675">G</tspan></text
	>
	<text
		id="text681"
		x="488.1"
		...
		font-family="helvetica"
		font-size="25.6"
		transform="matrix(1.33 0 0 1.33 -363 -108)"><tspan id="tspan679">U</tspan></text
	>
	<text
		id="text685"
		x="516"
		...
		font-family="helvetica"
		font-size="25.6"
		transform="matrix(1.33 0 0 1.33 -363 -108)"><tspan id="tspan683">A</tspan></text
	>
	<text
		id="text689"
		x="539.5"
		...
		font-family="helvetica"
		font-size="25.6"
		transform="matrix(1.33 0 0 1.33 -363 -108)"><tspan id="tspan687">M</tspan></text
	>
	<path
		id="path691"
		fill="#239e46"
	...
	<g
		id="text703"
		aria-label="G"
		style="font-size:25.6px;font-family:helvetica;fill:#bd0728"
		transform="matrix(1.33 0 0 1.33 -363 -108)"
	>
		<path
			id="path722"
			d="M475 250.7q2.6 0 4.5 1 2.7 1.4 3.3 5h-2.4q-.5-2-2-3-1.3-.9-3.5-.9-2.5 0-4.3 2-1.7 1.9-1.7 5.7 0 3.2 1.4 5.3 1.5 2 4.7 2 2.5 0 4.1-1.4 1.7-1.4 1.7-4.7h-5.7v-2h8v9.8h-1.6l-.6-2.4q-1.2 1.4-2.2 2-1.7.9-4.2.9-3.2 0-5.6-2.1-2.6-2.7-2.6-7.3t2.5-7.3q2.4-2.6 6.2-2.6zm-.4 0z"
		/>
	</g>
	<g
		id="text707"
	...
	>
		<path
			id="path725"
			d="M492.8 251.2v11.4q0 2 .7 3.3 1.1 2 3.8 2 3.1 0 4.3-2.1.6-1.2.6-3.2v-11.4h2.5v10.4q0 3.3-1 5.2-1.6 3.3-6.2 3.3-4.7 0-6.4-3.3-.9-1.9-.9-5.2v-10.4zm4.7 0z"
		/>
	</g>
	<g
		id="text711"
	...
	>
		<path
			id="path728"
			d="m527.4 262-2.8-8-3 8zm-4.1-10.8h2.8l6.7 18.4H530l-1.8-5.5h-7.3l-2 5.5h-2.5z"
		/>
	</g>
	<g
		id="text715"
	...
	>
		<path
			id="path731"
			d="M541.4 251.1h3.6l5.2 15.6 5.3-15.6h3.5v18.4h-2.4V254l-5.2 15.5H549l-5.3-15.5v15.5h-2.3z"
		/>
	</g>
</svg>
