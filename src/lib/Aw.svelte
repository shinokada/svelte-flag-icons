<script>export let size="24";export let ariaLabel="flag of aw" </script><svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-aw" width={size} height={size} class={$$props.class} {...$$restProps} aria-label={ariaLabel} viewBox="0 0 640 480">
  <defs>
    <clipPath id="aw-a">
