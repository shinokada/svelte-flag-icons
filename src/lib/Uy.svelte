...
>
  ...
  >
    <g id="uy-c">
      <g id="uy-b">
        ...
        </g> <use xlink:href="#uy-a" width="100%" height="100%" transform="rotate(45)" />
      </g> <use xlink:href="#uy-b" width="100%" height="100%" transform="rotate(90)" />
    </g> <use xlink:href="#uy-c" width="100%" height="100%" transform="scale(-1)" />
    <circle r="11" />
  </g>
  <g transform="translate(133.3 133.3)scale(.29333)">
    <g id="uy-d">
      ...
      />
    </g> <use xlink:href="#uy-d" width="100%" height="100%" transform="scale(-1 1)" />
